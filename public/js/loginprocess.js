module.exports = {
  ...
  email_generator: function(user){
    ...
    var mailOptions = {
        ...
        html: '<b>your email address is '+user.email+'🐴</b><a href="http://127.0.0.1:8081/urlprocess/?magiclink='+user.magiclink+'&role='+user.role+'\">http://127.0.0.1:8081/urlprocess/?magiclink='+user.magiclink+'&role='+user.role+'</a>' // html body 
    };
